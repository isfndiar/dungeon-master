...
export const BOSSES: Record<BossKind, BossDef> = {
  giant_slime: {
    ...
    spells: [
      // phase 1
      { kind: "split",       cooldown: 10, tier: 1 },
      { kind: "slimePool",   cooldown: 8,  tier: 1 },
      { kind: "bounceSlam",  cooldown: 9,  tier: 1 },
      // phase 2
      { kind: "split",       cooldown: 8,  tier: 2 },
      { kind: "slimePool",   cooldown: 6,  tier: 2 },
      { kind: "bounceSlam",  cooldown: 7,  tier: 2 },
      // phase 3
      { kind: "split",       cooldown: 6,  tier: 3 },
      { kind: "slimePool",   cooldown: 5,  tier: 3 },
      { kind: "bounceSlam",  cooldown: 5,  tier: 3 },
    ],
  },
  spider_queen: {
    ...
    spells: [
      { kind: "webBarrage",          cooldown: 7,  tier: 1 },
      { kind: "webTrap",             cooldown: 9,  tier: 1 },
      { kind: "summonSpiderlings",   cooldown: 11, tier: 1 },
      { kind: "webBarrage",          cooldown: 6,  tier: 2 },
      { kind: "webTrap",             cooldown: 7,  tier: 2 },
      { kind: "summonSpiderlings",   cooldown: 9,  tier: 2 },
      { kind: "webBarrage",          cooldown: 5,  tier: 3 },
      { kind: "webTrap",             cooldown: 6,  tier: 3 },
      { kind: "summonSpiderlings",   cooldown: 7,  tier: 3 },
    ],
  },
  lich: {
    ...
    spells: [
      { kind: "deathBeam",   cooldown: 10, tier: 1 },
      { kind: "boneRing",    cooldown: 7,  tier: 1 },
      { kind: "raiseDead",   cooldown: 12, tier: 1 },
      { kind: "deathBeam",   cooldown: 8,  tier: 2 },
      { kind: "boneRing",    cooldown: 6,  tier: 2 },
      { kind: "raiseDead",   cooldown: 10, tier: 2 },
      { kind: "deathBeam",   cooldown: 7,  tier: 3 },
      { kind: "boneRing",    cooldown: 5,  tier: 3 },
      { kind: "raiseDead",   cooldown: 8,  tier: 3 },
    ],
  },
  lava_golem: {
    ...
    spells: [
      { kind: "meteor",    cooldown: 12, tier: 1 },
      { kind: "lavaPool",  cooldown: 9,  tier: 1 },
      { kind: "eruption",  cooldown: 10, tier: 1 },
      { kind: "meteor",    cooldown: 10, tier: 2 },
      { kind: "lavaPool",  cooldown: 7,  tier: 2 },
      { kind: "eruption",  cooldown: 8,  tier: 2 },
      { kind: "meteor",    cooldown: 8,  tier: 3 },
      { kind: "lavaPool",  cooldown: 6,  tier: 3 },
      { kind: "eruption",  cooldown: 6,  tier: 3 },
    ],
  },
};
