...
export const monsterSprites: Record<string, SpriteDef> = {
  ...
  mermaid: {
    palette: { a: "#2ab5a0", b: "#1a8a7a", e: "#163a3a", w: "#80ffe0", h: "#ffd24a", t: "#e8a030" },
    rows: [
      "................",
      "....h.h.h.......",
      "....httht.......",
  ...
  anglerfish: {
    palette: { a: "#2a3a5a", b: "#1a2a3a", e: "#ff3a3a", w: "#ff9a4a", l: "#ffd24a", t: "#fff" },
    rows: [
      "........l.......",
      ".......ll.......",
      "......lw........",
...
export const bossSprites: Record<string, SpriteDef> = {
  ...
  octopus: {
    palette: { a: "#4a2a6a", b: "#3a1a4a", e: "#ffd24a", w: "#9a6aba", t: "#6a3a8a" },
    rows: [
      "........................",
      "..t..........t..........",
      "..tt........tt..........",
